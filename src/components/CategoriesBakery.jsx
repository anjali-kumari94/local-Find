...
import bakeryBanner from "../assets/bakery.jpg.jpg";
import breadImg from "../assets/bakery.jpg.jpg";
...
const subcategories = ["Bread", "Pastry", "Cake", "Muffin"];
const sortOptions = [
...
const CategoriesBakery = () => {
  ...
  let filtered = bakeryProducts.filter((p) => {
    const matchSub =
    ...
    <>
      <div className="flex flex-col md:flex-row gap-8 max-w-7xl mx-auto px-4 py-8">
        ...
        <main className="flex-1">
          {/* The Daily Crumb Business Card */}
          <div className="mb-8 flex justify-center">
            <Link
              to="/business/corner-bakery"
            ...
            >
              <div className="bg-white rounded-xl shadow-md flex flex-col md:flex-row items-center p-4 hover:shadow-lg transition cursor-pointer">
                <img
                  src={bakeryBanner}
                  alt="The Corner Bakery"
                  className="w-32 h-32 object-cover rounded-full mr-6"
                />
                <div>
                  <h2 className="text-2xl font-bold mb-1">The Corner Bakery</h2>
                  <div className="text-yellow-500 text-lg mb-1">★ 4.7</div>
                  <p className="text-gray-600 mb-1">
                    Freshly baked breads, pastries, and cakes made daily with
                    local ingredients.
                  </p>
          ...
          <div className="mb-8 rounded-lg overflow-hidden relative h-48 md:h-64 flex items-center justify-center">
            ...
            <div className="relative z-10 text-center">
              ...
              <p className="text-lg md:text-xl text-white drop-shadow max-w-2xl mx-auto">
                Freshly baked goods daily. Enjoy artisan breads, pastries,
                cakes, and more from your local bakery.
              </p>
            </div>
          </div>
...
export default CategoriesBakery;

...
import coffeeBanner from "../assets/coffee.jpg4.jpg";
import espressoImg from "../assets/coffee.jpg2.jpg";
import latteImg from "../assets/classiclatte.jpg";
import cappuccinoImg from "../assets/cappucino.jpg";
import beansImg from "../assets/coffee.jpg.jpg";
...
const subcategories = ["Espresso", "Latte", "Cappuccino", "Beans"];
const sortOptions = [
...
const CategoriesCoffee = () => {
  ...
  let filtered = coffeeProducts.filter((p) => {
    const matchSub =
    ...
    <>
      <div className="flex flex-col md:flex-row gap-8 max-w-7xl mx-auto px-4 py-8">
        ...
        <main className="flex-1">
          {/* Brewed Awakening Business Card */}
          <div className="mb-8 flex justify-center">
            <Link
              to="/business/brewed-awakening"
            ...
            >
              <div className="bg-white rounded-xl shadow-md flex flex-col md:flex-row items-center p-4 hover:shadow-lg transition cursor-pointer">
                <img
                  src={coffeeImg}
                  alt="Brewed Awakening"
                  className="w-32 h-32 object-cover rounded-full mr-6"
                />
                <div>
                  <h2 className="text-2xl font-bold mb-1">Brewed Awakening</h2>
                  <div className="text-yellow-500 text-lg mb-1">★ 4.6</div>
                  <p className="text-gray-600 mb-1">
                    Artisan coffee, espresso drinks, and pastries roasted and
                    baked locally.
                  </p>
          ...
          <div className="mb-8 rounded-lg overflow-hidden relative h-48 md:h-64 flex items-center justify-center">
            ...
            <div className="relative z-10 text-center">
              ...
              <p className="text-lg md:text-xl text-white drop-shadow max-w-2xl mx-auto">
                Artisan coffee roasted locally. Enjoy espresso, lattes,
                cappuccinos, and fresh beans from your neighborhood coffee shop.
              </p>
            </div>
          </div>
...
export default CategoriesCoffee;
